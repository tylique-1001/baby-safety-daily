...
def generate_html_report(urgent_news, important_news, reminder_news, tips, report_date, mode):
    ...
    html = (
        ...
        '    .section-heading.arrived { animation: sectionPulse 2.2s ease-out forwards; }\n'
        '    @keyframes sectionPulse {\n'
        '      0%   { background: rgba(255,94,98,0.20); border-left-color: var(--coral); box-shadow: inset 0 0 24px rgba(255,94,98,0.10); transform: scale(1.015); }\n'
        '      25%  { background: rgba(255,94,98,0.14); border-left-color: var(--coral); box-shadow: inset 0 0 12px rgba(255,94,98,0.05); transform: scale(1.005); }\n'
        '      100% { background: transparent; border-left-color: transparent; box-shadow: none; transform: scale(1); }\n'
        '    }\n'
